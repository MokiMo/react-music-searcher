...
import {initState as AppInitState} from "./redux/app/reducer";
...
describe("App Reducer", () => {
	...
	it("Test AUTH_SUCCESS -> Authentication", () => {
		...
		expect(AppReducer(undefined, { type: AppActions.AUTH_SUCCESS, payload: payload })).toEqual({
			...AppInitState,
			...payload,
			authenticated: true,
		});
...
describe("actions", () => {
	...
	it("should create an action to logout", () => {
		...
		expect(AppActions.logout("Passing payload, does absolutely nothing.")).toEqual(expectedAction);
	});
});
